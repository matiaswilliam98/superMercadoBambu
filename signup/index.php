...
<html lang="en">
<head>
	<title>Regístrate en Sistema E-commerce</title>
	<meta charset="UTF-8">
          ...
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper" style="text-decoration:none">
                  <a href="../login"  style=" text-decoration: none"><img style="pointer-events: none;" src="../imagenes/foto.png" alt="logo" class="logo" width="85" height="85"> <b style="font-size: 28px;">E-COMMERCE</b></a>
              </div>
              <form action="../Controlador/RegistroClientes.php" method="post">
                  ...
                  <input name="login" id="login" class="btn btn-block login-btn mb-4" type="submit" value="Registrarse en E-COMMERCE">
